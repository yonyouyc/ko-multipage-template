  ...
  if (params.id) {
    ...
    setTimeout(function () {
      ...
      if (params.id()) {
        ...
        uploader = initWebuploader(params.index, initFormData(this.prefix+params.id(), params.groupname), this.filelist, this.progresswidth)
        ...
        uploader = initWebuploader(params.index, initFormData('', params.groupname), this.filelist, this.progresswidth)
      }
    ...
    params.id.subscribe(function (val) {
      if(!hasQuery){
        //初始化webuploader
        uploader = initWebuploader(params.index, initFormData(this.prefix+val, params.groupname), this.filelist, this.progresswidth)
      }
...
//初始化webuploader
function initWebuploader (index, formData, filelist, progresswidth_ko) {
